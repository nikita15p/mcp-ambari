...
func (o *CreateCluster) Validate(a map[string]interface{}) error { return req(a, "clusterName", "body") }
func (o *CreateCluster) Execute(ctx context.Context, a map[string]interface{}) (interface{}, error) {
	var body interface{}; if s, ok := a["body"].(string); ok { json.Unmarshal([]byte(s), &body) } else { body = a["body"] }
...
func (o *UpdateAlertDefinition) Validate(a map[string]interface{}) error { return req(a, "clusterName", "definitionId") }
func (o *UpdateAlertDefinition) Execute(ctx context.Context, a map[string]interface{}) (interface{}, error) {
	body := map[string]interface{}{}
	if e, ok := a["enabled"].(bool); ok { body["AlertDefinition/enabled"] = e }
	if d, ok := a["data"].(string); ok { var extra map[string]interface{}; json.Unmarshal([]byte(d), &extra); for k, v := range extra { body[k] = v } }
...
func (o *CreateAlertGroup) Validate(a map[string]interface{}) error { return req(a, "clusterName", "groupName") }
func (o *CreateAlertGroup) Execute(ctx context.Context, a map[string]interface{}) (interface{}, error) {
	...
	if d, ok := a["definitions"].(string); ok { var defs interface{}; json.Unmarshal([]byte(d), &defs); body["AlertGroup"].(map[string]interface{})["definitions"] = defs }
...
func (o *UpdateAlertGroup) Validate(a map[string]interface{}) error { return req(a, "clusterName", "groupName") }
...
func (o *DuplicateAlertGroup) Validate(a map[string]interface{}) error { return req(a, "clusterName", "newGroupName") }
func (o *DuplicateAlertGroup) Execute(ctx context.Context, a map[string]interface{}) (interface{}, error) {
	...
	if src != nil { if ag, ok := src["AlertGroup"].(map[string]interface{}); ok { if defs, ok := ag["definitions"]; ok { body["AlertGroup"].(map[string]interface{})["definitions"] = defs } } }
...
func (o *RemoveDefinitionFromGroup) Validate(a map[string]interface{}) error { return req(a, "clusterName") }
...
func (o *CreateNotification) Validate(a map[string]interface{}) error { return req(a, "clusterName", "notificationData") }
func (o *CreateNotification) Execute(ctx context.Context, a map[string]interface{}) (interface{}, error) {
	var body interface{}; json.Unmarshal([]byte(a["notificationData"].(string)), &body)
...
func (o *UpdateNotification) Validate(a map[string]interface{}) error { return req(a, "clusterName", "notificationData") }
...
func (o *AddNotificationToGroup) Validate(a map[string]interface{}) error { return req(a, "clusterName") }
...
func (o *RemoveNotificationFromGroup) Validate(a map[string]interface{}) error { return req(a, "clusterName") }
...
func (o *RestartComponents) Validate(a map[string]interface{}) error { return req(a, "clusterName", "serviceName", "componentName") }
func (o *RestartComponents) Execute(ctx context.Context, a map[string]interface{}) (interface{}, error) {
	...
	ctxMsg := "Restart components via MCP"; if c, ok := a["context"].(string); ok { ctxMsg = c }
...
func (o *DisableMaintenanceMode) Validate(a map[string]interface{}) error { return req(a, "clusterName", "serviceName") }
